...
| [`shared-policy`](https://github.com/Aryamanz29/mergeproof/tree/main/examples/shared-policy) | one organisation policy extended by a service: a rule replaced, one disabled, one added |
